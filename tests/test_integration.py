...
These tests require a test database. They are skipped if DATABASE_URL is not set.
To run integration tests locally, set DATABASE_URL to a test database.
"""
...
# Only import these if we're actually running the tests
if os.getenv("DATABASE_URL"):
    ...
    async def initialize_tests():
        ...
        await initializer(
            ["models.expert", "models.availability_error"],
